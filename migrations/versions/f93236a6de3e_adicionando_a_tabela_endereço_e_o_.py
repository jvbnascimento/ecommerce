"""Adicionando a tabela Endereço e o relacionamento com Usuário

Revision ID: f93236a6de3e
Revises: 
Create Date: 2020-06-04 10:28:17.634682
...
def upgrade():
    ...
    sa.Column('bairro', sa.String(length=36), nullable=True),
    sa.Column('cidade', sa.String(length=36), nullable=True),
    ...
    sa.ForeignKeyConstraint(['produto_id'], ['produto.id'], ),
    sa.PrimaryKeyConstraint('compra_id', 'produto_id')
    )
